...
# Other requirements:
1. You should have at least 3 tests.  (see `src/companents/button.test.jsx`[https://github.com/encore428/movies/src/companents/button.test.jsx], `src/companents/label.test.jsx`, `src/domains/movie/components/movie-item.test.jsx`.)
