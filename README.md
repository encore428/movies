...
1. The comment form should be validated.  (see [`src/domains/movie/components/movie-details.jsx`](https://github.com/encore428/movies/blob/master/src/components/movie-details.jsx).)
