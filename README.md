...
# Other requirements:
1. You should have at least 3 tests.  (see [`src/companents/button.test.jsx`](https://github.com/encore428/movies/blob/master/src/components/button.test.jsx), `src/companents/label.test.jsx`, `src/domains/movie/components/movie-item.test.jsx`.)
...
<table>
   ...
   <tr><td>33.</td><td>Change URL to https://boring-galileo-dc314c.netlify.app/login.</td>
